...
public sealed class MedicalClaimResponse
{
    ...
    public ClaimCalculatedValues CalculatedValues { get; set; } = new();

    public ClaimRecommendationResponse? LatestRecommendation { get; set; }
}
